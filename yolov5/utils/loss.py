...
class ComputeLoss:
    ...
    def build_targets(self, p, targets):
        ...
        for i in range(self.nl):
            anchors, shape = self.anchors[i], p[i].shape ### ETFS
            ...
            indices.append((b, a, gj.clamp_(0, shape[2] - 1), gi.clamp_(0, shape[3] - 1)))  # image, anchor, grid ### ETFS
            ### indices.append((b, a, gj.clamp_(0, int(gain[3]) - 1), gi.clamp_(0, int(gain[2]) - 1))) ### ETFS (outra possibilidade)
